...
print(ggplot2::ggplot(comm.melt, aes(x=variable, y=value, group=Questions, colour=Questions))+geom_line()+theme(axis.text.x=element_text(angle=-90))+xlab("n_factors")+ylab("communalities"))
@ 
